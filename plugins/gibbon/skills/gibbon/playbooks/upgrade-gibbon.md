...
This step is outside Magneto Agent — the tenant clicks "Update" in the Clouve marketplace UI, or Clouve ops triggers a redeploy with the new `GIBBON_VERSION` in the app's compose. Tell the user:
